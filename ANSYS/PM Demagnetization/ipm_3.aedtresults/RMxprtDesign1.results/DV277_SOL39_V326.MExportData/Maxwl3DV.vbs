...
oModule.AssignSlave Array("NAME:Slave", "Objects:=", Array("SlaveSheet"), _
  Array("NAME:CoordSysVector", "Origin:=", Array("0mm", "0mm", "0mm"), _
  "UPos:=", Array("-60mm", "7.3478807948841199e-15mm", "0mm")), "ReverseV:=", _
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_0:CreateUserDefinedPart:1", "LenRegion", "65mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_1:CreateUserDefinedPart:1", "LenRegion", "65mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_2:CreateUserDefinedPart:1", "LenRegion", "65mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_3:CreateUserDefinedPart:1", "LenRegion", "65mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_4:CreateUserDefinedPart:1", "LenRegion", "65mm + 2*endRegion"
On Error Goto 0
...
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTerm_5:CreateUserDefinedPart:1", "LenRegion", "65mm + 2*endRegion"
On Error Goto 0
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "10deg"), Array("NAME:Pair", "Name:=", "LenRegion", "Value:=", _
  "103.5996833275845mm"), Array("NAME:Pair", "Name:=", "InfoCoil", "Value:=", _
  "3"))), Array("NAME:Attributes", "Name:=", "CoilTermRe_0", "Flags:=", "", _
  "Color:=", "(250 167 14)", "Transparency:=", 0, "PartCoordinateSystem:=", _
  "Global", "MaterialName:=", "copper_75C", "SolveInside:=", true) 
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTermRe_0:CreateUserDefinedPart:1", "LenRegion", "65mm + 2*endRegion"
On Error Goto 0
oEditor.Rotate Array("NAME:Selections", "Selections:=", "CoilTermRe_0"), _
  Array("NAME:RotateParameters", "CoordinateSystemID:=", -1, "RotateAxis:=", _
  "Z", "RotateAngle:=", "330deg")
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/LapCoil", "Version:=", "12.0", "NoOfParameters:=", 21, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "75mm"), Array("NAME:Pair", "Name:=", _
  ...
  "10deg"), Array("NAME:Pair", "Name:=", "LenRegion", "Value:=", _
  "103.5996833275845mm"), Array("NAME:Pair", "Name:=", "InfoCoil", "Value:=", _
  "3"))), Array("NAME:Attributes", "Name:=", "CoilTermRe_1", "Flags:=", "", _
  "Color:=", "(250 167 14)", "Transparency:=", 0, "PartCoordinateSystem:=", _
  "Global", "MaterialName:=", "copper_75C", "SolveInside:=", true) 
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTermRe_1:CreateUserDefinedPart:1", "LenRegion", "65mm + 2*endRegion"
On Error Goto 0
oEditor.Rotate Array("NAME:Selections", "Selections:=", "CoilTermRe_1"), _
  Array("NAME:RotateParameters", "CoordinateSystemID:=", -1, "RotateAxis:=", _
  "Z", "RotateAngle:=", "30deg")
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/LapCoil", "Version:=", "12.0", "NoOfParameters:=", 21, _
  ...
  "10deg"), Array("NAME:Pair", "Name:=", "LenRegion", "Value:=", _
  "103.5996833275845mm"), Array("NAME:Pair", "Name:=", "InfoCoil", "Value:=", _
  "3"))), Array("NAME:Attributes", "Name:=", "CoilTermRe_2", "Flags:=", "", _
  "Color:=", "(250 167 14)", "Transparency:=", 0, "PartCoordinateSystem:=", _
  "Global", "MaterialName:=", "copper_75C", "SolveInside:=", true) 
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTermRe_2:CreateUserDefinedPart:1", "LenRegion", "65mm + 2*endRegion"
On Error Goto 0
oEditor.Rotate Array("NAME:Selections", "Selections:=", "CoilTermRe_2"), _
  Array("NAME:RotateParameters", "CoordinateSystemID:=", -1, "RotateAxis:=", _
  "Z", "RotateAngle:=", "90deg")
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/LapCoil", "Version:=", "12.0", "NoOfParameters:=", 21, _
  ...
  "10deg"), Array("NAME:Pair", "Name:=", "LenRegion", "Value:=", _
  "103.5996833275845mm"), Array("NAME:Pair", "Name:=", "InfoCoil", "Value:=", _
  "3"))), Array("NAME:Attributes", "Name:=", "CoilTermRe_3", "Flags:=", "", _
  "Color:=", "(250 167 14)", "Transparency:=", 0, "PartCoordinateSystem:=", _
  "Global", "MaterialName:=", "copper_75C", "SolveInside:=", true) 
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTermRe_3:CreateUserDefinedPart:1", "LenRegion", "65mm + 2*endRegion"
On Error Goto 0
oEditor.Rotate Array("NAME:Selections", "Selections:=", "CoilTermRe_3"), _
  Array("NAME:RotateParameters", "CoordinateSystemID:=", -1, "RotateAxis:=", _
  "Z", "RotateAngle:=", "150deg")
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/LapCoil", "Version:=", "12.0", "NoOfParameters:=", 21, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "75mm"), Array("NAME:Pair", "Name:=", _
  ...
  "10deg"), Array("NAME:Pair", "Name:=", "LenRegion", "Value:=", _
  "103.5996833275845mm"), Array("NAME:Pair", "Name:=", "InfoCoil", "Value:=", _
  "3"))), Array("NAME:Attributes", "Name:=", "CoilTermRe_4", "Flags:=", "", _
  "Color:=", "(250 167 14)", "Transparency:=", 0, "PartCoordinateSystem:=", _
  "Global", "MaterialName:=", "copper_75C", "SolveInside:=", true) 
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTermRe_4:CreateUserDefinedPart:1", "LenRegion", "65mm + 2*endRegion"
On Error Goto 0
oEditor.Rotate Array("NAME:Selections", "Selections:=", "CoilTermRe_4"), _
  Array("NAME:RotateParameters", "CoordinateSystemID:=", -1, "RotateAxis:=", _
  "Z", "RotateAngle:=", "210deg")
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/LapCoil", "Version:=", "12.0", "NoOfParameters:=", 21, _
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "75mm"), Array("NAME:Pair", "Name:=", _
  ...
  "10deg"), Array("NAME:Pair", "Name:=", "LenRegion", "Value:=", _
  "103.5996833275845mm"), Array("NAME:Pair", "Name:=", "InfoCoil", "Value:=", _
  "3"))), Array("NAME:Attributes", "Name:=", "CoilTermRe_5", "Flags:=", "", _
  "Color:=", "(250 167 14)", "Transparency:=", 0, "PartCoordinateSystem:=", _
  "Global", "MaterialName:=", "copper_75C", "SolveInside:=", true) 
On Error Resume Next
oEditor.SetPropertyValue "Geometry3DCmdTab", _
  "CoilTermRe_5:CreateUserDefinedPart:1", "LenRegion", "65mm + 2*endRegion"
On Error Goto 0
oEditor.Rotate Array("NAME:Selections", "Selections:=", "CoilTermRe_5"), _
  Array("NAME:RotateParameters", "CoordinateSystemID:=", -1, "RotateAxis:=", _
  "Z", "RotateAngle:=", "270deg")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oModule.AssignLengthOp Array("NAME:Length_Mag", "RefineInside:=", true, _
  "Objects:=", Array("Mag1_0", "Mag1_1", "Mag1_2", "Mag1_3", "Mag1_4", _
  "Mag1_5", "Mag1_6", "Mag1_7", "Mag1_8", "Mag1_9", "Mag2_0", "Mag2_1", _
  "Mag2_2", "Mag2_3", "Mag2_4", "Mag2_5", "Mag2_6", "Mag2_7", "Mag2_8", _
  "Mag2_9"), "RestrictElem:=", false, "NumMaxElem:=", "1000", _
  "RestrictLength:=", true, "MaxLength:=", "3mm")
Set oModule = oDesign.GetModule("MeshSetup")
oModule.ReassignOp "Length_Mag", Array("Objects:=", Array("Mag1_0", "Mag1_1", _
  "Mag1_2", "Mag1_3", "Mag1_4", "Mag1_5", "Mag1_6", "Mag1_7", "Mag1_8", _
  "Mag1_9", "Mag2_0", "Mag2_1", "Mag2_2", "Mag2_3", "Mag2_4", "Mag2_5", _
  "Mag2_6", "Mag2_7", "Mag2_8", "Mag2_9"))
On Error Goto 0
On Error Resume Next
Set oModule = oDesign.GetModule("MeshSetup")
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "9.2mm")
Set oModule = oDesign.GetModule("MeshSetup")
...
oEditor.Move Array("NAME:Selections", "Selections:=", "CoilTerm_0,CoilTerm_1" & _
  ",CoilTerm_2,CoilTerm_3,CoilTerm_4,CoilTerm_5,CoilTermRe_0,CoilTermRe_1" & _
  ",CoilTermRe_2,CoilTermRe_3,CoilTermRe_4,CoilTermRe_5"), Array(_
...
oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "Band,InnerRegion" & _
  ",Shaft,Stator,Coil_0,Coil_1,Coil_2,Coil_3,Coil_4,Coil_5,CoilTerm_0" & _
  ",CoilTerm_1,CoilTerm_2,CoilTerm_3,CoilTerm_4,CoilTerm_5,CoilTermRe_0" & _
  ",CoilTermRe_1,CoilTermRe_2,CoilTermRe_3,CoilTermRe_4,CoilTermRe_5,Rotor" & _
  ",Mag1_0,Mag1_1,Mag1_2,Mag1_3,Mag1_4,Mag1_5,Mag1_6,Mag1_7,Mag1_8,Mag1_9" & _
  ",Mag2_0,Mag2_1,Mag2_2,Mag2_3,Mag2_4,Mag2_5,Mag2_6,Mag2_7,Mag2_8,Mag2_9", _
